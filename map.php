            ...
            <div id="layer-sidenav" class="sidenav rmv-obj-left">
				...
				<ul class="nav">
					...
					<li class="has-sub">
						...
						<ul class="sub-menu">
						    <li><a href="#"><input type="checkbox" name="checkMaps8" id="check8" value="" onclick="tiledLayer('pci','http://<?php echo $aws; ?>:8080/geoserver/gwc/service/gmaps?layers=SmallCells:smallcells_xy&zoom={z}&x={x}&y={y}&format=image/png8',0,1);"  > Cells Planned</a></li> 
                            <li><a href="#"><input type="radio" name="optionsMaps" id="radio24" value="option24" onclick="tiledLayer('pci','http://<?php echo $aws; ?>:8080/geoserver/gwc/service/gmaps?layers=SmallCells:SmallCells_xy_density&zoom={z}&x={x}&y={y}&format=image/png8',0,1);"> Starling Density</a></li>
                        </ul>
					</li>
				...
				<ul class="nav">
                    ...
                    <li class="has-sub">
						...
						<ul class="sub-menu">
						    ...
						    <li><a href="#"><input type="radio" name="options3G" id="Par_6" value="SC"> 2G-BCCH/SC/PCI</a>  <input type="text" style="width:80px; position: relative; left:80px;" class="form-control" id="channel" placeholder="Val"></li>                            
                    ...
                    <li class="has-sub" >
						...
						<ul class="sub-menu" id="list-selection">
                            <div class="col-xs-14">
                                ...
                                <div>
                                    <button class="btn btn-default" onclick="clearSelection();" id="delete-button">Clear</button>
                                </div>                        
